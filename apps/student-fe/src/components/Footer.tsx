...
export const Footer: React.FC = () => {
  return (
    <footer className="border-t border-black/5 bg-[#EFEFEE] dark:bg-[#121215] text-[#141414] dark:text-white pt-14 pb-12 transition-colors duration-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-12">
          {/* Brand Column */}
          <div className="md:col-span-1 space-y-4">
            <div className="flex items-center space-x-2.5">
              <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-[#8266F0] to-[#EC4899] flex items-center justify-center text-white">
            ...
            <div className="flex items-center space-x-2 text-[11px] text-[#6B6B6B] dark:text-slate-400">
              <Accessibility className="w-4 h-4 text-[#8266F0]" />
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-[#6B6B6B] dark:text-slate-400">
              <li><a href="#home" className="hover:text-[#8266F0] transition">Home & Overview</a></li>
              <li><a href="#diagnostic" className="hover:text-[#8266F0] transition">AI Diagnostic Loop</a></li>
              <li><a href="#courses" className="hover:text-[#8266F0] transition">Curriculum Explorer</a></li>
              <li><a href="#pacing" className="hover:text-[#8266F0] transition">Adaptive Velocity</a></li>
              <li><a href="#paths" className="hover:text-[#8266F0] transition">5-Stage Learning Path</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-[#6B6B6B] dark:text-slate-400">
              <li><a href="#teacher" className="hover:text-[#8266F0] transition">Cohort Misconception Heatmap</a></li>
              <li><a href="#mentors" className="hover:text-[#8266F0] transition">Faculty Directory</a></li>
              <li><a href="#pacing" className="hover:text-[#8266F0] transition">Laboratory Simulators</a></li>
          ...
          <div>
            ...
            <div className="bg-black/5 dark:bg-white/5 p-4 rounded-2xl space-y-2 border border-black/5 dark:border-white/10">
              <div className="flex items-center space-x-2 text-xs font-mono text-[#8266F0]">
