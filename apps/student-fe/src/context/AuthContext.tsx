...
export const AuthProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const syncUserWithFirestore = async (
    ...
    const baseProfile: UserProfile = {
      ...
      photoURL: fbUser.photoURL || extraData?.photoURL || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(fbUser.displayName || fbUser.email || "Learner")}`,
    ...
    try {
      ...
      if (userSnap && userSnap.exists()) {
        ...
        const mergedProfile: UserProfile = {
          ...
          photoURL: fbUser.photoURL || data.photoURL || baseProfile.photoURL || `https://api.dicebear.com/7.x/avataaars/svg?seed=${encodeURIComponent(data.displayName || fbUser.email || "Learner")}`,
